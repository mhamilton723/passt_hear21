...
def passt_s_swa_p16_128_ap476(pretrained=False, **kwargs):
    ...
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    print("Loading PASST TRAINED ON AUDISET")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
...
def passt_s_p16_s16_128_ap468(pretrained=False, **kwargs):
    ...
    """
    print("Loading PaSST pre-trained on AudioSet Patch 16 stride 16 structured patchout mAP=472")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
...
def passt_s_swa_f128_stfthop100_p16_s10_ap473(pretrained=False, **kwargs):
    ...
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    print("Loading PASST TRAINED ON AUDISET, with STFT hop of 100")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
...
def passt_s_swa_f128_stfthop160_p16_s10_ap473(pretrained=False, **kwargs):
    ...
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    print("Loading PASST TRAINED ON AUDISET, with STFT hop of 160")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
...
def openmic_passt_s_f128_10sec_p16_s10_ap85(pretrained=False, **kwargs):
    ...
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    print("Loading PASST TRAINED ON OpenMIC-2008")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
...
def fsd50k_passt_s_f128_p16_s10_ap655(pretrained=False, **kwargs):
    ...
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    print("Loading PASST TRAINED ON fsd50k ap655")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
...
def fsd50k_passt_s_n_f128_p16_s16_ap642(pretrained=False, **kwargs):
    ...
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    print("Loading PASST TRAINED ON fsd50k without patch overlap")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
...
def passt_s_f128_20sec_p16_s10_ap474_swa(pretrained=False, **kwargs):
    print("Loading PASST TRAINED ON AUDISET with 20 Second time encodings")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
...
def passt_s_f128_30sec_p16_s10_ap473_swa(pretrained=False, **kwargs):
    print("Loading PASST TRAINED ON AUDISET with 30 Second time encodings")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
...
def passt_b_f128_p16_s16_ap_459(pretrained=False, **kwargs):
    print("Loading PASST BASE TRAINED ON AUDISET with NO patchout")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
...
def passt_u600_f128_p16_s16_ap_460(pretrained=False, **kwargs):
    print("Loading PASST-U TRAINED ON AUDISET with Unstructured patchout")
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, **kwargs)
    model = _create_vision_transformer(
